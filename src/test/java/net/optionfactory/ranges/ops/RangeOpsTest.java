...
public class RangeOpsTest {
    ...
    public void canPerformDifferenceOnTwoDisjointRanges() {
        final Range<Integer, Long> lhs = RangeMother.r(0, 10);
        final Range<Integer, Long> rhs = RangeMother.r(11, 20);
        Assertions.assertEquals(RangeMother.r(0, 10), ops.difference(lhs, rhs));
    }

    @Test
    public void canPerformDifferenceOnTwoOverlappingRanges() {
        Range<Integer, Long> lhs = RangeMother.r(0, 10);
        Range<Integer, Long> rhs = RangeMother.r(8, 20);
        Assertions.assertEquals(RangeMother.r(0, 7), ops.difference(lhs, rhs));
    }

    @Test
    public void canPerformDifferenceOnTwoOverlappingRangesWithRhsLower() {
        Range<Integer, Long> lhs = RangeMother.r(8, 20);
        Range<Integer, Long> rhs = RangeMother.r(0, 10);
        Assertions.assertEquals(RangeMother.r(11, 20), ops.difference(lhs, rhs));
    }

    @Test
    public void canPerformDifferenceOnTwoNestedRanges() {
        Range<Integer, Long> lhs = RangeMother.r(0, 20);
        Range<Integer, Long> rhs = RangeMother.r(4, 10);
        Assertions.assertEquals(RangeMother.r(RangeMother.p(0, 3), RangeMother.p(11, 20)), ops.difference(lhs, rhs));
    }

    @Test
    public void canPerformDifferenceOnSelf() {
        Range<Integer, Long> x = RangeMother.r(0, 20);
        Assertions.assertEquals(RangeMother.empty(), ops.difference(x, x));
    }

    @Test
    public void canPerformDifferenceYieldingEmptyRange() {
        Range<Integer, Long> lhs = RangeMother.r(0, 10);
        Range<Integer, Long> rhs = RangeMother.r(0, 100);
        Assertions.assertFalse(ops.difference(lhs, rhs).iterator().hasNext());
    }

    @Test
    public void canPerformIntersectOnTwoNonOverlappingRanges() {
        Range<Integer, Long> lhs = RangeMother.r(0, 1);
        Range<Integer, Long> rhs = RangeMother.r(2, 3);
        Assertions.assertFalse(ops.intersection(lhs, rhs).iterator().hasNext());
    }

    @Test
    public void canPerformIntersectWithSparseRanges() {
        Range<Integer, Long> lhs = RangeMother.r(RangeMother.p(0, 1), RangeMother.p(2, 4));
        Range<Integer, Long> rhs = RangeMother.r(RangeMother.p(0, 1), RangeMother.p(5, 7));
        Assertions.assertEquals(RangeMother.r(0, 1), ops.intersection(lhs, rhs));
    }
    ...
    public void canPerformIntersectOnTwoOverlappingRanges() {
        Range<Integer, Long> lhs = RangeMother.r(0, 20);
        Range<Integer, Long> rhs = RangeMother.r(4, 10);
        Assertions.assertEquals(RangeMother.r(4, 10), ops.intersection(lhs, rhs));
    }

    @Test
    public void canPerformsymmetriDifferenceOnTwoRanges() {
        Range<Integer, Long> lhs = RangeMother.r(0, 15);
        Range<Integer, Long> rhs = RangeMother.r(10, 20);
        Assertions.assertEquals(RangeMother.r(RangeMother.p(0, 9), RangeMother.p(16, 20)), ops.symmetricDifference(lhs, rhs));
    }
    ...
    public void desnifyEmptyRangesIntoEmptyRange() {
        final Range<Integer, Long> got = ops.canonicalize(List.of());
        Assertions.assertEquals(RangeMother.empty(), got);
    }
}
